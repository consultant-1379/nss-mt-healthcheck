...
transaction_id=$transaction_id_$NODE
...
echo "<ManagedElement xmlns=\"urn:com:ericsson:ecim:ComTop\"><managedElementId>$NODE_NAME</managedElementId><BscFunction xmlns=\"urn:com:ericsson:ecim:BscFunction\"><bscFunctionId>1</bscFunctionId><BscM xmlns=\"urn:com:ericsson:ecim:BscM\"><bscMId>1</bscMId><UtraNetwork><utraNetworkId>1</utraNetworkId><ExternalUtranCell xc:operation=\"delete\"><externalUtranCellId>$ID</externalUtranCellId></ExternalUtranCell></UtraNetwork></BscM></BscFunction></ManagedElement>" >> comand_file.txt
