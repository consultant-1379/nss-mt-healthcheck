...
public interface ConfigurationExtendedOperations  extends BasicConfig.BasicConfigurationOperations
{
  ...
  /** Operation: get_CS_interface_version
         ...
         *
         */
  String[] get_CS_interface_version ();
  ...
  /**
         ...
         */
  ConfigExtended.SessionExtended create_extended_session (String id, int idlTimeout) throws BasicConfig.ProcessingFailure;
  ...
  /** Operation: get_MIB_info_ext
         ...
         *						release&name prefix.
         */
  ConfigExtended.MIBInfoExt get_MIB_info_ext (BasicConfig.MIBRef mib, BasicConfig.Session session) throws BasicConfig.UnsupportedQoS, BasicConfig.NotDefined, BasicConfig.SecurityViolation, BasicConfig.ProcessingFailure;
