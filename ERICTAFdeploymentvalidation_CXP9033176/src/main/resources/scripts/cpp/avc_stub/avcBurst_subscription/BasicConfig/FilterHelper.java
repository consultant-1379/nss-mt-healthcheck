...
{
  private static String  _id = "IDL:BasicConfig/Filter/Filter:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (BasicConfig.FilterHelper.id (), "Filter", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    BasicConfig.Filter value = new BasicConfig.Filter ();
    value.type = istream.read_string ();
    value.constraint = istream.read_string ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, BasicConfig.Filter value)
  {
    ...
    ostream.write_string (value.constraint);
  }
