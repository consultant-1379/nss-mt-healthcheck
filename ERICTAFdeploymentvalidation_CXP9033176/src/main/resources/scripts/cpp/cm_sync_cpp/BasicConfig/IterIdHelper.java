...
/**
   ...
   */
abstract public class IterIdHelper
{
  private static String  _id = "IDL:BasicConfig/IterId:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.IterIdHelper.id (), "IterId", __typeCode);
    }
    return __typeCode;
  }
