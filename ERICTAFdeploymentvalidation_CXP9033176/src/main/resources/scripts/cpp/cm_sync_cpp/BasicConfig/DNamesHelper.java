...
/**
* BasicConfig/DNamesHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from configuration_G.idl
* Friday, June 1, 2018 12:05:47 PM GMT+01:00
*/

abstract public class DNamesHelper
{
  private static String  _id = "IDL:BasicConfig/DNames:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.DNameHelper.id (), "DName", __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.DNamesHelper.id (), "DNames", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static CosNaming.NameComponent[][] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = BasicConfig.DNameHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, CosNaming.NameComponent[][] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      BasicConfig.DNameHelper.write (ostream, value[_i0]);
  }
