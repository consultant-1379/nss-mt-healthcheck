...
/**
* BasicConfig/QoSListHelper.java .
...
{
  private static String  _id = "IDL:BasicConfig/QoSList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.QoSTypeHelper.id (), "QoSType", __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.QoSListHelper.id (), "QoSList", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static short[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = BasicConfig.QoSTypeHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, short[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      BasicConfig.QoSTypeHelper.write (ostream, value[_i0]);
  }
