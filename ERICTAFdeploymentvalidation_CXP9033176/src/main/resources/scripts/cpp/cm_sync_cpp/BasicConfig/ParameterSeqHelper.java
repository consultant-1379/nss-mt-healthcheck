...
/**
* BasicConfig/ParameterSeqHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from configuration_G.idl
* Friday, June 1, 2018 12:05:47 PM GMT+01:00
*/

abstract public class ParameterSeqHelper
{
  private static String  _id = "IDL:BasicConfig/ParameterSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.ParameterSeqHelper.id (), "ParameterSeq", __typeCode);
    }
    return __typeCode;
  }
