...
/**
* BasicConfig/NameValueHelper.java .
...
{
  private static String  _id = "IDL:BasicConfig/NameValue/NameValue:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (BasicConfig.NameValueHelper.id (), "NameValue", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    BasicConfig.NameValue value = new BasicConfig.NameValue ();
