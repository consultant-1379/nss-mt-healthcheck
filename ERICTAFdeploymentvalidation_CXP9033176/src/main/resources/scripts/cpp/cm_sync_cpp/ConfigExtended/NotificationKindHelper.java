...
abstract public class NotificationKindHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_enum_tc (ConfigExtended.NotificationKindHelper.id (), "NotificationKind", new String[] { "MOCreatedType", "MODeletedType", "AVCType", "OverflowType"} );
    }
    return __typeCode;
  }
