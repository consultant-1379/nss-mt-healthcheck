...
{
  private static String  _id = "IDL:BasicConfig/TimeT:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BasicConfig.TimeTHelper.id (), "TimeT", __typeCode);
    }
    return __typeCode;
  }
