...
public final class ConfigNotification implements org.omg.CORBA.portable.IDLEntity
{
  ...
  private ConfigExtended.ACNotification ___attributeChanged;
  private ConfigExtended.SequenceDeltaNotification ___sequenceAttributeChanged;
  ...
  public ConfigExtended.ACNotification attributeChanged ()
  {
    if (__uninitialized)
      throw new org.omg.CORBA.BAD_OPERATION ();
    verifyattributeChanged (__discriminator);
    return ___attributeChanged;
  }

  public void attributeChanged (ConfigExtended.ACNotification value)
  {
    __discriminator = ConfigExtended.NotificationKind.ACType;
    ___attributeChanged = value;
    __uninitialized = false;
  }

  public void attributeChanged (ConfigExtended.NotificationKind discriminator, ConfigExtended.ACNotification value)
  {
    verifyattributeChanged (discriminator);
    __discriminator = discriminator;
    ___attributeChanged = value;
    __uninitialized = false;
  }

  private void verifyattributeChanged (ConfigExtended.NotificationKind discriminator)
  {
    if (discriminator != ConfigExtended.NotificationKind.ACType)
      throw new org.omg.CORBA.BAD_OPERATION ();
  }

  public ConfigExtended.SequenceDeltaNotification sequenceAttributeChanged ()
  {
    if (__uninitialized)
      throw new org.omg.CORBA.BAD_OPERATION ();
    verifysequenceAttributeChanged (__discriminator);
    return ___sequenceAttributeChanged;
  }

  public void sequenceAttributeChanged (ConfigExtended.SequenceDeltaNotification value)
  {
    __discriminator = ConfigExtended.NotificationKind.SequenceDeltaType;
    ___sequenceAttributeChanged = value;
    __uninitialized = false;
  }

  public void sequenceAttributeChanged (ConfigExtended.NotificationKind discriminator, ConfigExtended.SequenceDeltaNotification value)
  {
    verifysequenceAttributeChanged (discriminator);
    __discriminator = discriminator;
    ___sequenceAttributeChanged = value;
    __uninitialized = false;
  }

  private void verifysequenceAttributeChanged (ConfigExtended.NotificationKind discriminator)
  {
    if (discriminator != ConfigExtended.NotificationKind.SequenceDeltaType)
      throw new org.omg.CORBA.BAD_OPERATION ();
  }
  ...
  public String toString(){
    return "NotificationType:" + __discriminator + "\n" + "CreatedMO:" + ___createdMO + "\n" + "DeletedMO:" + ___deletedMO + "\n" + "UpdatedMO:" + ___updatedMO + "\n" + "AttributeChanged:" + ___attributeChanged + "\n" + "SequenceAttributeChanged:" +___sequenceAttributeChanged + "\n" + "Overflow:" + ___overflow;
  }
