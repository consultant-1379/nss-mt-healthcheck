...
/**
* NotificationIRPSystem/NotificationIRPOperationsPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from NotificationIRPSystem_F.idl
* Wednesday, July 11, 2018 2:25:15 PM GMT+01:00
*/

public abstract class NotificationIRPOperationsPOA extends org.omg.PortableServer.Servant
 implements NotificationIRPSystem.NotificationIRPOperationsOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("attach_push", new java.lang.Integer (0));
    _methods.put ("attach_push_b", new java.lang.Integer (1));
    _methods.put ("attach_pull", new java.lang.Integer (2));
    _methods.put ("detach", new java.lang.Integer (3));
    _methods.put ("get_notification_IRP_version", new java.lang.Integer (4));
    _methods.put ("get_subscription_status", new java.lang.Integer (5));
    _methods.put ("get_subscription_ids", new java.lang.Integer (6));
    _methods.put ("change_subscription_filter", new java.lang.Integer (7));
    _methods.put ("get_notification_categories", new java.lang.Integer (8));
  }
  ...
  /* ## Operation: attach_push
      */
       case 0:  // NotificationIRPSystem/NotificationIRPOperations/attach_push
       {
         try {
  ...
  /* ## Operation: attach_push_b
      */
       case 1:  // NotificationIRPSystem/NotificationIRPOperations/attach_push_b
       {
         try {
           org.omg.CORBA.Object manager_reference = org.omg.CORBA.ObjectHelper.read (in);
           int time_tick = in.read_long ();
  ...
  /* ## Operation: attach_pull
      */
       case 2:  // NotificationIRPSystem/NotificationIRPOperations/attach_pull
       {
         try {
           org.omg.CORBA.Object manager_reference = org.omg.CORBA.ObjectHelper.read (in);
           int time_tick = in.read_long ();
  ...
  /* ## Operation: detach
      */
       case 3:  // NotificationIRPSystem/NotificationIRPOperations/detach
       {
         try {
           org.omg.CORBA.Object manager_reference = org.omg.CORBA.ObjectHelper.read (in);
  ...
  /* ## Operation: get_notification_IRP_version
      */
       case 4:  // NotificationIRPSystem/NotificationIRPOperations/get_notification_IRP_version
       {
         try {
           String $result[] = null;
  ...
  /* ## Operation: get_subscription_status
      */
       case 5:  // NotificationIRPSystem/NotificationIRPOperations/get_subscription_status
       {
         try {
           String subscription_id = in.read_string ();
  ...
  /* ## Operation: get_subscription_ids
      */
       case 6:  // NotificationIRPSystem/NotificationIRPOperations/get_subscription_ids
       {
         try {
           org.omg.CORBA.Object manager_reference = org.omg.CORBA.ObjectHelper.read (in);
           String $result[] = null;
  ...
  /* ## Operation: change_subscription_filter
      */
       case 7:  // NotificationIRPSystem/NotificationIRPOperations/change_subscription_filter
       {
         try {
           String subscription_id = in.read_string ();
           String filter = in.read_string ();
  ...
  /* ## Operation: get_notification_categories
      */
       case 8:  // NotificationIRPSystem/NotificationIRPOperations/get_notification_categories
       {
         try {
  ...
  public NotificationIRPOperations _this() 
  {
    return NotificationIRPOperationsHelper.narrow(
    super._this_object());
  }

  public NotificationIRPOperations _this(org.omg.CORBA.ORB orb) 
  {
    return NotificationIRPOperationsHelper.narrow(
...
} // class NotificationIRPOperationsPOA
