...
/**
* CelloNotificationIRPExtension/PerceivedSeverityHelper.java .
...
{
  private static String  _id = "IDL:CelloNotificationIRPExtension/PerceivedSeverity:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CelloNotificationIRPExtension.PerceivedSeverityHelper.id (), "PerceivedSeverity", __typeCode);
    }
    return __typeCode;
  }
